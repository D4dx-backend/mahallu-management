        ...
        const actionItems: ActionMenuItem[] = [
          {
            label: 'View',
            icon: <FiEye />,
            onClick: () => navigate(ROUTES.PROGRAMS.DETAIL(row.id)),
          },
          {
            label: 'Edit',
            icon: <FiEdit2 />,
            onClick: () => navigate(`/programs/${row.id}/edit`),
          },
          {
            label: 'Delete',
            icon: <FiTrash2 />,
    ...
    <div className="space-y-4">
      ...
      <Card>
        ...
        {loading ? (
          ...
          <Table columns={columns} data={programs} emptyMessage="No programs found" showExport={false} />
        )}
