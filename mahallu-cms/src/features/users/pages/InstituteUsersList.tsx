        ...
        const actionItems: ActionMenuItem[] = [
          {
            label: 'View',
            icon: <FiEye />,
            onClick: () => navigate(`/users/institute/${row.id}`),
          },
          {
            label: 'Edit',
            icon: <FiEdit2 />,
            onClick: () => navigate(`/users/institute/${row.id}/edit`),
          },
        ];
    ...
    <div className="space-y-4">
      ...
      <Card>
        ...
        {loading ? (
          ...
          <Table columns={columns} data={users} emptyMessage="No institute users found" showExport={false} />
        )}
      </Card>
    </div>
  );
