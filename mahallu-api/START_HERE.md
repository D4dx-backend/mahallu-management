...
→ Update `.env` with `DXING_SECRET` and `DXING_ACCOUNT`

### "401 Unauthorized"
→ Wrong secret - get fresh one from DXING dashboard

### "Still no dashboard entry"
→ Run diagnostic: `npx ts-node scripts/test-dxing.ts 919999999999`

### "Where do I find secret/account?"
→ Log into https://app.dxing.in → API Settings
